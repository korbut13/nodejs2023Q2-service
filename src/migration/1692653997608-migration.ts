...
export class Migration1692653997608 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "albums_to_favs" ("id" SERIAL NOT NULL, "albumId" uuid, CONSTRAINT "REL_5c63c1b84911d6488d5e624987" UNIQUE ("albumId"), CONSTRAINT "PK_a5fc5d5b6e14326856aa70b89bf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "artists_to_favs" ("id" SERIAL NOT NULL, "artistId" uuid, CONSTRAINT "REL_99be808472a74f6e84b8178c42" UNIQUE ("artistId"), CONSTRAINT "PK_1c61d785ec25f8ff73c923d119c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tracks_to_favs" ("id" SERIAL NOT NULL, "trackId" uuid, CONSTRAINT "REL_bc2b36ae316764404407c79350" UNIQUE ("trackId"), CONSTRAINT "PK_ee9303eb61c7192d157ab55b72b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "refreshToken" character varying NOT NULL, CONSTRAINT "REL_d417e5d35f2434afc4bd48cb4d" UNIQUE ("userId"), CONSTRAINT "PK_3001e89ada36263dabf1fb6210a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "albums_to_favs" ADD CONSTRAINT "FK_5c63c1b84911d6488d5e624987b" FOREIGN KEY ("albumId") REFERENCES "albums"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "artists_to_favs" ADD CONSTRAINT "FK_99be808472a74f6e84b8178c42e" FOREIGN KEY ("artistId") REFERENCES "artists"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tracks_to_favs" ADD CONSTRAINT "FK_bc2b36ae316764404407c79350a" FOREIGN KEY ("trackId") REFERENCES "tracks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tracks_to_favs" DROP CONSTRAINT "FK_bc2b36ae316764404407c79350a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "artists_to_favs" DROP CONSTRAINT "FK_99be808472a74f6e84b8178c42e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "albums_to_favs" DROP CONSTRAINT "FK_5c63c1b84911d6488d5e624987b"`,
    );
    await queryRunner.query(
